...
$query_log_to_DB = "java -Xms16G -Xmx16G -jar " . $tassel . " sliceRangeNuke -bf -sf " . $sourceFile . " -st " . $sourceFormat . " -df " . $outputFile . " -dt " . $output_format . " -tf ". $taxaFile . " -ch " . $chromosome . "  -start " .  $startPosition . "  -end " . $endPosition;
