...
Sends input via POST-method to milestone_send.php
Use-case: "Given a specific genomic position and a specific lines, what allele is present?
          List all the lines which have the same allele in the same genomic position."-->
<html>
	<head>
	...
	<body>
	 	<form action="milestone_send.php" method="post">
		<table border="2">
			<tr>
				<td> Chromosome : 
				</td>
			...
			<tr>
				...
				<td> <input id="position" name="position" type="number">
				</td>
			</tr>
			<tr>
				<td>
